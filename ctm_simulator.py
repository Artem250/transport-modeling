"""Основной сетевой CTM-симулятор для сценарных расчётов."""
...
NODE_SOLVER_NAME = "explicit_diverge_merge_general_ctm_node_solver"
...
class CTMSimulator:
    ...
    def _add_movement(
        ...
        movement = {
            ...
            "movement_capacity_pcu_h": round(
                self._movement_capacity_pcu_s(in_link, out_link, turn_type) * 3600.0,
                3,
            ),
            "movement_capacity_limited_count": 0,
            "node_solver_case": "",
            "active_constraints": [],
        }
    ...
    def _movement_summary(self) -> dict[str, Any]:
        ...
        return {
            ...
            "node_solver_case_counts": getattr(self, "node_solver_case_counts", {}),
            ...
            "movement_capacity_model": "neutral_by_default_turn_type_factor_times_min_link_capacity",
            "movement_capacity_limited_count": sum(
                movement.get("movement_capacity_limited_count", 0) for movement in self.movements
            ),
            "incident_model": "lane_blockage_or_direct_capacity_factor_or_none",
            "merge_priority_model": "manual_overrides_or_equal_default",
            "manual_merge_priority_count": len(self.config.merge_priorities or {}),
            "turn_ratio_model": "manual_overrides_or_synthetic_inference",
        }
