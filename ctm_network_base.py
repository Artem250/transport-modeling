"""Shared heuristic network-simulator layer for the active CTM simulator.

The public scenario-facing simulator is exported from ``ctm_network_simulator``.
This module keeps the legacy proportional movement builder and queue/history
machinery that the active simulator extends.
"""
